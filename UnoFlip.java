...
public class UnoFlip {
    ...
    public UnoFlip(List<UnoPlayer> players, Deck deck) {
        ...
        this.roundNumber=1;
        scan = new Scanner(System.in);// why are using this here Renuas notes.
    ...
    public void drawCard(){
        ...
        this.getCurrentPlayer().drawCard(drawnCard);
    }
...
*/
        ...
        while (!unoGameWon) {
            ...
            List<Card> playableCards = currentHand.getPlayableCards(currentCard, chosenColor);//cards that are suitable to be played.
            System.out.println();
            ...
            if (!playableCards.isEmpty()) {// if list is not empty

                if (currentCard.getCardType() == Card.CardType.SKIP) {// card on didscard pile
            ...
            if (deck.isEmpty()) {
                deck.reAdd();// clears market basically
            }
