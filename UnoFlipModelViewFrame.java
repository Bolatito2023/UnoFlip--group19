...
public class UnoFlipModelViewFrame extends JFrame implements UnoFlipModelView {
    ...
    private JScrollPane scrollPane;//to see all cards incase a draw2
    ...
    public UnoFlipModelViewFrame() {
        ...
        southTextArea = new JTextArea("Player " + currentPlayer.getPlayerName() +"'s Turn");//players turn
        southTextArea.setEditable(false);
        centerButton = new JButton("CurrentCard on pile");// current card button
        ...
        this.setSize(1000, 1000); // Adjust the size as needed
    ...
    //Update to show which players turn it is
